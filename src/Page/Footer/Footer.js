    ...
    return (
        <section className=' pt-20 footer_area'>
            <div className='max-w-7xl mx-auto grid grid-cols-3 gap-10 text-center'>
                ...
                <div className=''>
                    <h1 className='text-8xl primary-color'>Gerícht</h1>
                    <p className='pt-16'>"The best way to find yourself is to lose yourself in the service of others.”</p>
                    ...
                    <div class="flex justify-center space-x-2 pt-10">
                        <a href="#!" role="button">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="w-7 h-7" style={{ color: "#dcca87" }}>
                        ...
                        <a href="#!" role="button">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-7 h-7" style={{ color: "#dcca87" }}>
                        ...
                        <a href="#!" role="button">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512" class="w-7 h-7" style={{ color: "#dcca87" }}>
                        ...
                        <a href="#!" role="button">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-7 h-7" style={{ color: "#dcca87" }}>
                ...
                <div className='pt-24'>
                    <h1 className='text-3xl primary-color'>Working Hours</h1>
                    <p className='pt-8'>Monday-Friday: <br />
                        08:00 am -12:00 am</p>
