    ...
    return (
        <section className='details_area mt-24  flex flex-row justify-center items-center'>
            <div className='max-w-7xl mx-auto mt-16 mb-16'>
                <div className='grid grid-cols-3 md:grid-cols-1 gap-5 details_content special'>
                    <div className='text-end centers'>
                        <h1 className='text-6xl primary-color '>About Us</h1>
                        <p className='text-end centers about_details pt-5'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Et, sapiente modi atque praesentium deserunt esse unde iusto doloribus assumenda totam ut non vitae necessitatibus deleniti consequatur reiciendis. Voluptates, repellat incidunt.</p>
                    </div>
